...
public class TradedBookRVAdapter extends RecyclerView.Adapter <TradedBookRVAdapter.MyViewHolder> {
    Context context;
    ArrayList<BookRVModel> list;
    public TradedBookRVAdapter(Context context, ArrayList<BookRVModel> list ) {
